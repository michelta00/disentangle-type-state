...
```{r}
ggplot(
  data = all_scores_z$patches_clu_con_full,
  mapping = aes(x = tPVE_z, group_score_max_abs_Patches_z)
) +
  geom_point() +
  geom_smooth() +
  theme_minimal() +
  labs(
    x = "tPVE", y = "GroupMaxAbs", 
    title = "Patches Cluster + Condition for Full Data"
   )
